...
#include <dumux/material/components/co2_not.hh>
...
#include <dumux/material/binarycoefficients/h2_co2_not.hh>
...
public:
    ...
    static constexpr int comp3Idx = CH4Idx; //!< index of the second component
    static constexpr int comp2Idx = CO2Idx; // secondary component
    static constexpr int comp1Idx = H2Idx; // third component
    static constexpr int comp4Idx = N2Idx;

    static constexpr int liquidCompIdx = H2OIdx; //!< index of the liquid component
    static constexpr int gasCompIdx = H2Idx; //!< index of the gas component
