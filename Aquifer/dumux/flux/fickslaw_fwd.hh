...
/*!
 * \ingroup Flux
 * \brief Evaluates the diffusive mass flux according to Fick's law molarAveraged or massAveraged
 */
template <class TypeTag, ReferenceSystemFormulation referenceSystem =  ReferenceSystemFormulation::molarAveraged>
