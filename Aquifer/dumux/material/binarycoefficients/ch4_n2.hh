 ...
 */
#ifndef DUMUX_BINARY_COEFF_CH4_N2_HH
#define DUMUX_BINARY_COEFF_CH4_N2_HH
...
public:
    ...
    static Scalar gasDiffCoeff(Scalar temperature, Scalar pressure)
    {
      ...
      using N2 = Dumux::Components::N2<Scalar>;
        ...
        const Scalar SigmaNu[2] = { 25.14 /* CH4 */,  18.5 /* N2 */ };
        // molar masses [g/mol]
        const Scalar M[2] = { CH4::molarMass()*1e3, N2::molarMass()*1e3 };
    ...
    {
    	using Comp1= Dumux::Components::CH4<Scalar>;
