...
public:
    ...
    {
        DUNE_THROW(Dune::NotImplemented, "henry coefficient for methane in liquid hydrogen");
    };
    ...
    static Scalar gasDiffCoeff(Scalar temperature, Scalar pressure)
    {
        ...
        const Scalar SigmaNu[2] = { 6.12 /* H2 */,  25.14 /* CH4 */ };
        // molar masses [g/mol]
        const Scalar M[2] = { H2::molarMass()*1e3, CH4::molarMass()*1e3 };
    ...
    {
        DUNE_THROW(Dune::NotImplemented, "diffusion coefficient for liquid methane and hydrogen");
    };
};
