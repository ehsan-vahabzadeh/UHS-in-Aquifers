...
public:
    /*!
     * \brief Henry coefficent \f$[N/m^2]\f$  for molecular carbon dioxide in liquid water.
     *
     * See:
     *
...
//        Scalar mu = SimpleCO2::gasViscosity(temperature, pressure); // CO2 viscosity
...
//        return D;
        ...
        const Scalar SigmaNu[2] = { 28.12 /* CO2 */,  13.1 /* H2O */ };
        // molar masses [g/mol]
        const Scalar M[2] = { CO2::molarMass()*1e3, H2O::molarMass()*1e3 };
    ...
    static Scalar liquidDiffCoeff(Scalar temperature, Scalar pressure)
    {
    	...
    	const Scalar Texp = 298 /*+ 25*/; // [K]
    	        const Scalar Dexp = 2.00e-9; // [m^2/s]
