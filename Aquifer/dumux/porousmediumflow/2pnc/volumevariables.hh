...
public:
    ...
    */
    ...
    /*!
     * \brief Returns the Fugacity Coefficient of a given phase within the
     *        control volume.
     *
     * \param phaseIdx The phase index
     */
    Scalar FugacityCoefficient(int phaseIdx) const
    {
        if (phaseIdx < ModelTraits::numFluidPhases())
            return fluidState_.Fugacity_Coefficient(phaseIdx);
