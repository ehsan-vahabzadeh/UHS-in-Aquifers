...
int main(int argc, char** argv)
{
    ...
    // std::string folderPath = "."; // Specify the folder path or use "." for the current directory
    // try {
    ...
    std::cout << "The material balance error is: " << tEnd <<  std::endl;
