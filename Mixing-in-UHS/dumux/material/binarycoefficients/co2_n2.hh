 ...
 * \file
 *
 * \brief Binary coefficients for hydrogen and H2S.
 */
#ifndef DUMUX_BINARY_COEFF_CO2_N2_HH
#define DUMUX_BINARY_COEFF_CO2_N2_HH
...
public:
    ...
    static Scalar gasDiffCoeff(Scalar temperature, Scalar pressure)
    {
        ...
        const Scalar SigmaNu[2] = { 26.9 /* CO2 */,  18.5 /* N2 */ };    // FF
        // molar masses [g/mol]
        const Scalar M[2] = { CO2::molarMass()*1e3, N2::molarMass()*1e3 };
    ...
    {
    	using Comp1= Dumux::Components::SimpleCO2<Scalar>;
        ...
        // atomic diffusion volumes
        const Scalar SigmaNu[2] = { 26.9 /* CO2 */,  18.5 /* N2 */ };  
        // molar masses [g/mol]
