...
public:
    ...
    { return 0.2917; /* [-] */ }
    /*!
     * \brief Returns the critical compressibility factor \f$\mathrm{[m3/mol]}\f$ of \f$ N2\f$.
     */
    static Scalar Zc()
    { return 0.2917; /* [-] */ }
    /*!
    ...
    /*!
     * \brief Returns the atomic diffusion volume of nitrogen according to Reid
     */
